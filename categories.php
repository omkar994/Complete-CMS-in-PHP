...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        elseif(strlen($category) < 3 || strlen($category) > 50){
            $_SESSION["errorMessage"]="* Category Title should be min 3 and max 50 characters";
            redirectTo("categories.php");
        }

        else{
            global $ConnectingDB;
            $sql= "INSERT INTO cms.category(title,author,datetime) VALUES(:titlE,:authoR,:datetimE)";
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container" style="background:lavender">
                ...
                <ul class="nav mr-auto">
                    ...
                    <li class="nav-item"><a href="adminmaster.php" class="nav-link">Manage Admins</a></li>
        ...
        <header class="bg-dark text-white py-3">
            <div class="cointainer">
                <div class="row">
                    <div class="col-md-12">
                      <h1 style="padding-left: 50px;"><i class="fas fa-edit" style="padding-left: 5px;"></i>Manage Categories</h1>
                   </div>
                </div>
            </div>
        </header>
                    ...
                    <div class="card  bg-secondary text-light mb-3">
                        ...
                        <div class="card-body bg-dark">
                            <div class="form-group">
                                ...
                                <input  class="form-control mb-3" type="text" id="title" name="categoryTitle">
